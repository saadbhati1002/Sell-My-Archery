...
//     BTAppContextSwitcher.setReturnURLScheme("com.sellmyarchary.chirag.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.sellmyarchary.chirag.braintree") == .orderedSame {
