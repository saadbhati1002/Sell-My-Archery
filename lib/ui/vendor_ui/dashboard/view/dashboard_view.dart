  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: MultiProvider(
          ...
          ChangeNotifierProvider<NotificationProvider>(
              ...
              create: (BuildContext context) {
                final NotificationProvider provider = NotificationProvider(
                    repo: notificationRepository, psValueHolder: psValueHolder);
        ...
        child: Consumer2<UserProvider, UserUnreadMessageProvider>(
          builder: (BuildContext context, UserProvider provider,
              UserUnreadMessageProvider unreadMessageProvider, Widget? child) {
            /**
               * UI SECTION
               */
            return Scaffold(
