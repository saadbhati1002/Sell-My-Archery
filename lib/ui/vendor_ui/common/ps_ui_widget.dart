...
class MyPsNetworkImage extends StatefulWidget {
  const MyPsNetworkImage(
      {Key? key,
      required this.photoKey,
      required this.defaultPhoto,
      required this.imageAspectRation,
  ...
  @override
  State<MyPsNetworkImage> createState() => _MyPsNetworkImageState();
}

class _MyPsNetworkImageState extends State<MyPsNetworkImage> {
  @override
  Widget build(BuildContext context) {
    final PsValueHolder psValueHolder = Provider.of<PsValueHolder>(context);
    double height2 = 500;
