...
class CheckoutView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String? discountTotal = ((double.parse(productDetailAndAddress
    ...
    final String? subTotal = (double.parse(productDetailAndAddress
                    ?.productDetailIntentHolder?.currentPrice
                    .toString() ??
                '0') *
            int.parse(productDetailAndAddress
    ...
    final String? totalPrice = (double.parse(productDetailAndAddress
                    ?.productDetailIntentHolder?.currentPrice
                    .toString() ??
                '0') *
            int.parse(productDetailAndAddress
    ...
    bool isShippingDataNull(dynamic shippingOrBillingholder) {
      if (shippingOrBillingholder.firstName == null ||
          shippingOrBillingholder.lastName == null ||
          shippingOrBillingholder.address == null ||
          shippingOrBillingholder.city == null ||
          shippingOrBillingholder.code == null ||
          shippingOrBillingholder.country == null ||
          shippingOrBillingholder.email == null ||
          shippingOrBillingholder.phone == null ||
          shippingOrBillingholder.postalCode == null ||
          shippingOrBillingholder.state == null) {
        return true;
      }
      return false;
    }
              ...
              body: Stack(children: <Widget>[
                ...
                OrderPlaceButtonWidget(
                    onPressed: () async {
                      if (value.selectedValue != 1) {
                      ...
                      } else if (isShippingDataNull(shippingAddressHolder) ==
                          true) {
                        showDialog<dynamic>(
                            context: context,
                            builder: (BuildContext context) {
                      ...
                      } else if (isShippingDataNull(billingAddressHolder) ==
                          true) {
                        showDialog<dynamic>(
                            context: context,
                            builder: (BuildContext context) {
                        ...
                        if (pro.data?.isSoldOutItem == true) {
                          ...
                          final PsResource<OrderId> data = await value.postData(
                            requestBodyHolder: OrderAndBillingParameterHolder(
                                ...
                                billingState:
                                    productDetailAndAddress?.billingAddressHolder?.state,
